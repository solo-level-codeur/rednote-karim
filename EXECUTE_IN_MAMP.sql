-- =====================================
-- SCRIPT À EXÉCUTER DANS MAMP/phpMyAdmin
-- Database: memo
-- =====================================

-- IMPORTANT: Sélectionner la base "memo" avant d'exécuter !

-- Nettoyer et redémarrer les permissions
...
SELECT 
    ...
    GROUP_CONCAT(p.permission_name ORDER BY p.permission_name SEPARATOR ', ') as permissions_list
FROM roles r 
